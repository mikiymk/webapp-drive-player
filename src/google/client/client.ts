  ...
  try {
      ...
      "function" === typeof Object.assign
        ...
        : function (a, b) {
            for (let c = 1; c < arguments.length; c++) {
              const d = arguments[c];
              if (d) for (const e in d) fa(d, e) && (a[e] = d[e]);
            }
            return a;
          };
    ...
    q("Promise", function (a) {
      ...
      e.prototype.B = function () {
        if (null != this.h) {
          for (let g = 0; g < this.h.length; ++g) f.h(this.h[g]);
          this.h = null;
        }
      };
      var f = new b();
      ...
      e.race = function (g) {
        return new e(function (h, k) {
          for (let m = _.u(g), n = m.next(); !n.done; n = m.next())
            c(n.value).Wa(h, k);
        });
      };
      e.all = function (g) {
          ...
          if (n && fa(h.h, m))
            for (h = 0; h < n.length; h++) {
              ...
              if ((k !== k && p.key !== p.key) || k === p.key)
                return { id: m, list: n, index: h, P: p };
            }
          return { id: m, list: n, index: -1, P: void 0 };
        },
        e = function (h, k) {
          let m = h.g;
          return ea(function () {
            if (m) {
              for (; m.head != h.g; ) m = m.ga;
              for (; m.next != m.head; )
...
*/
    ...
    _.Pa =
      ...
      !_.w("Edge");
    _.Qa = -1 != _.qa().toLowerCase().indexOf("webkit") && !_.w("Edge");
    _.Ra = _.ua();
    a: {
      let Ta = "",
        Ua = (function () {
          const a = _.qa();
          if (_.Pa) return /rv:([^\);]+)(\)|;)/.exec(a);
          if (_.Oa) return /Edge\/([\d\.]+)/.exec(a);
          if (_.Na) return /\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(a);
          if (_.Qa) return /WebKit\/(\S+)/.exec(a);
          if (_.Ma) return /(?:Version)[ \/]?(\S+)/.exec(a);
        })();
      Ua && (Ta = Ua ? Ua[1] : "");
      if (_.Na) {
        let Va,
    ...
    ya.set("error", 3);
    _.za = "warn";
    for (var Ya = [], Za = 0; 63 > Za; Za++) Ya[Za] = 0;
    _.$a = (function (a) {
    ...
    _.ab = {};
    _.bb = new _.D("about:invalid#zClosurez", _.ab);
    let fb;
    _.cb = {};
    _.db = function (a, b) {
      this.g = b === _.cb ? a : "";
    ...
    fb = new _.db((_.v.trustedTypes && _.v.trustedTypes.emptyHTML) || "", _.cb);
    _.gb = (function (a) {
      let b = !1,
        c;
      return function () {
    ...
    _.ib.prototype.ta = !1;
    _.ib.prototype.S = function () {
      this.ta || ((this.ta = !0), this.W());
    };
    _.ib.prototype.W = function () {
    ...
    var mb = function (a, b) {
      ...
      if (a) {
        ...
        d
          ...
          : ((this.i = _.Qa || void 0 !== a.offsetX ? a.offsetX : a.layerX),
            (this.j = _.Qa || void 0 !== a.offsetY ? a.offsetY : a.layerY),
        ...
        this.state = a.state;
        this.T = a;
        a.defaultPrevented && mb.oa.preventDefault.call(this);
      }
    };
    _.B(mb, _.jb);
    var lb = { 2: "touch", 3: "pen", 4: "mouse" };
    mb.prototype.stopPropagation = function () {
      mb.oa.stopPropagation.call(this);
      this.T.stopPropagation
        ? this.T.stopPropagation()
        : (this.T.cancelBubble = !0);
    };
    mb.prototype.preventDefault = function () {
      mb.oa.preventDefault.call(this);
      const a = this.T;
      a.preventDefault ? a.preventDefault() : (a.returnValue = !1);
    };
    mb.prototype.Sc = function () {
      return this.T;
    };
    let nb;
    nb = "closure_listenable_" + ((1e6 * Math.random()) | 0);
    _.ob = function (a) {
      return !(!a || !a[nb]);
    };
    let pb = 0;
    const qb = function (a, b, c, d, e) {
        this.listener = a;
        this.proxy = null;
        this.src = b;
        this.type = c;
    ...
    sb.prototype.add = function (a, b, c, d, e) {
      ...
      -1 < g
        ? ((b = a[g]), c || (b.Va = !1))
        : ((b = new qb(b, this.src, f, !!d, e)), (b.Va = c), a.push(b));
      return b;
    };
    ub = function (a, b) {
      const c = b.type;
      if (!(c in a.g)) return !1;
      const d = _.wa(a.g[c], b);
      d && (rb(b), 0 == a.g[c].length && (delete a.g[c], a.h--));
      return d;
    };
    _.vb = function (a, b) {
      b = b && b.toString();
      ...
      for (d in a.g)
        if (!b || d == b) {
          for (let e = a.g[d], f = 0; f < e.length; f++) ++c, rb(e[f]);
          delete a.g[d];
          a.h--;
        }
    };
    sb.prototype.Ia = function (a, b, c, d) {
      a = this.g[a.toString()];
      let e = -1;
      a && (e = tb(a, b, c, d));
      return -1 < e ? a[e] : null;
    ...
    var tb = function (a, b, c, d) {
      for (let e = 0; e < a.length; ++e) {
        const f = a[e];
        if (!f.Ja && f.listener == b && f.capture == !!c && f.handler == d)
          return e;
      }
      return -1;
    };
    let wb, xb, yb, Bb, Db, Hb, Eb, Gb, Jb;
    wb = "closure_lm_" + ((1e6 * Math.random()) | 0);
    xb = {};
    yb = 0;
    _.E = function (a, b, c, d, e) {
      if (d && d.once) return _.zb(a, b, c, d, e);
      if (Array.isArray(b)) {
        for (let f = 0; f < b.length; f++) _.E(a, b[f], c, d, e);
        return null;
      }
      c = _.Ab(c);
      return _.ob(a)
        ? a.I(b, c, _.Ga(d) ? !!d.capture : !!d, e)
        : Bb(a, b, c, !1, d, e);
    };
    Bb = function (a, b, c, d, e, f) {
      if (!b) throw Error("n");
      let g = _.Ga(e) ? !!e.capture : !!e,
        h = _.Cb(a);
      h || (a[wb] = h = new sb(a));
      c = h.add(b, c, d, g, f);
      if (c.proxy) return c;
    ...
    _.zb = function (a, b, c, d, e) {
      if (Array.isArray(b)) {
        for (let f = 0; f < b.length; f++) _.zb(a, b[f], c, d, e);
        return null;
      }
      c = _.Ab(c);
      return _.ob(a)
        ? a.Db(b, c, _.Ga(d) ? !!d.capture : !!d, e)
        : Bb(a, b, c, !0, d, e);
    };
    Hb = function (a, b, c, d, e) {
      if (Array.isArray(b))
        for (let f = 0; f < b.length; f++) Hb(a, b[f], c, d, e);
      else
        (d = _.Ga(d) ? !!d.capture : !!d),
          (c = _.Ab(c)),
          _.ob(a)
            ? a.pa(b, c, d, e)
            : a && (a = _.Cb(a)) && (b = a.Ia(b, c, d, e)) && _.Ib(b);
    };
    _.Ib = function (a) {
      if ("number" === typeof a || !a || a.Ja) return !1;
      const b = a.src;
      if (_.ob(b)) return ub(b.X, a);
      let c = a.type,
        d = a.proxy;
      ...
      yb--;
      (c = _.Cb(b))
        ? (ub(c, a), 0 == c.h && ((c.src = null), (b[wb] = null)))
        : rb(a);
      return !0;
    };
    Eb = function (a) {
    ...
    _.l.dispatchEvent = function (a) {
      let b,
        c = this.G;
      if (c) for (b = []; c; c = c.G) b.push(c);
      c = this.va;
      const d = a.type || a;
      if ("string" === typeof a) a = new _.jb(a, c);
    ...
    _.Kb.prototype.Ia = function (a, b, c, d) {
      return this.X.Ia(String(a), b, c, d);
    };
    const Mb = function () {};
    Mb.prototype.g = null;
    let Ob;
    ...
    let Wb, Yb, gc, Zb, ac, $b, ec, bc, hc, kc;
    _.Rb = function (a) {
      ...
      a instanceof _.Rb
        ...
        ? ((this.l = !1),
          ...
          _.Ub(this, b[6] || "", !0),
          (this.m = Wb(b[7] || "")))
        : ((this.l = !1), (this.j = new _.Xb(null, this.l)));
    };
    _.Rb.prototype.toString = function () {
      ...
      if ((c = this.i))
        this.g && "/" != c.charAt(0) && a.push("/"),
          a.push(Yb(c, "/" == c.charAt(0) ? $b : ac, !0));
      (c = this.j.toString()) && a.push("?", c);
      (c = this.m) && a.push("#", Yb(c, bc));
      return a.join("");
    };
    _.Rb.prototype.resolve = function (a) {
      let b = new _.Rb(this),
        c = !!a.h;
      c ? _.Sb(b, a.h) : (c = !!a.o);
      c ? (b.o = a.o) : (c = !!a.g);
    ...
    _.Ub = function (a, b, c) {
      b instanceof _.Xb
        ? ((a.j = b), cc(a.j, a.l))
        : (c || (b = Yb(b, ec)), (a.j = new _.Xb(b, a.l)));
    };
    _.fc = function (a) {
      return a instanceof _.Rb ? new _.Rb(a) : new _.Rb(a);
    };
    Wb = function (a, b) {
      return a
        ? b
    ...
    _.Xb.prototype.add = function (a, b) {
      hc(this);
      this.i = null;
      a = ic(this, a);
      let c = this.g.get(a);
    ...
    _.l.ea = function (a) {
      ...
      let b = [];
      if ("string" === typeof a)
        kc(this, a) && (b = b.concat(this.g.get(ic(this, a))));
      else {
    ...
    _.l.set = function (a, b) {
      ...
      this.i = null;
      a = ic(this, a);
      kc(this, a) && (this.h -= this.g.get(a).length);
      this.g.set(a, [b]);
      this.h += 1;
      return this;
    };
    ...
    _.lc = function (a, b, c) {
      _.jc(a, b);
      0 < c.length &&
        ((a.i = null), a.g.set(ic(a, b), _.xa(c)), (a.h += c.length));
    };
...
*/
    ...
    _.qc = function () {
      return _.w("Android") && !(_.oc() || _.nc() || _.ra() || _.w("Silk"));
    };
    _.rc = function (a, b) {
      b = String(b);
    ...
    _.yc.prototype.Ha = function () {
      return zc(this).keys;
    };
    _.yc.prototype.ea = function () {
  ...
  try {
    ...
    Pc = function (a, b) {
      Object.isExtensible(a) &&
        (Nc ? a[Nc] && (a[Nc] &= ~b) : void 0 !== a.aa && (a.aa &= ~b));
    };
    _.Qc = function (a) {
      let b;
      Nc ? (b = a[Nc]) : (b = a.aa);
    ...
    _.Yc = function (a, b, c, d) {
      c = void 0 === c ? !1 : c;
      d = void 0 === d ? !1 : d;
      if (Array.isArray(a)) return new b(d ? _.Tc(a) : a);
      if (c) return new b();
    };
    _.ad = function (a) {
      switch (typeof a) {
    ...
    cd = function (a, b, c) {
      if (null != a) {
        if (Array.isArray(a)) a = _.bd(a, b, c);
        else if (Wc(a)) {
          let d = {},
            e;
          for (e in a) d[e] = cd(a[e], b, c);
          a = d;
        } else a = b(a);
        return a;
      }
    ...
    _.bd = function (a, b, c) {
      ...
      c(a, d);
      for (a = 0; a < d.length; a++) d[a] = cd(d[a], b, c);
      return d;
    };
    dd = function (a) {
      if (a && "object" === typeof a && a.toJSON) return a.toJSON();
      a = _.ad(a);
      return Array.isArray(a) ? _.bd(a, dd, ed) : a;
    };
    ed = function () {};
    jd = function (a, b, c, d, e, f) {
      (a = a.C && a.C[c])
        ? Array.isArray(a)
          ? ((e = f.xb ? _.Sc(a.slice()) : a), _.fd(b, c, e))
          : _.gd(b, c, a)
        : (Lc && d instanceof Uint8Array
            ? (e = d.length ? new _.$c(new Uint8Array(d), _.hd) : _.id())
            : (Array.isArray(d) &&
                (e
                  ? _.Oc(d, 2)
                  : d && _.Qc(d) & 1 && f.xb
    ...
    _.sd = function (a, b, c, d) {
      b = b(c || nd, d);
      if (_.Ga(b))
        if (b instanceof _.od) {
          if (b.Aa !== pd) throw Error("Y");
          b = qd(b.toString());
        } else b = rd("zSoyz");
      else b = rd(String(b));
      if ((0, _.gb)()) for (; a.lastChild; ) a.removeChild(a.lastChild);
      a.innerHTML = _.eb(b);
    };
    td = function (a) {
      let b = typeof a;
    ...
    _.yd = function (a, b) {
      let c = 0;
      a = (0, _.Ha)(String(a)).split(".");
      b = (0, _.Ha)(String(b)).split(".");
    ...
    Fd = function (a, b, c) {
      if ("function" === typeof a) c && (a = (0, _.wd)(a, c));
      else if (a && "function" === typeof a.handleEvent)
        a = (0, _.wd)(a.handleEvent, a);
      else throw Error("r");
    ...
    Id = [];
    Jd = function (a) {
      a.v && a.Lb && (a.v.ontimeout = null);
      a.fb && (_.v.clearTimeout(a.fb), (a.fb = null));
    };
    Kd = function (a) {
      return (
        _.Na && Bd() && "number" === typeof a.timeout && void 0 !== a.ontimeout
      );
    };
    Ld = function (a) {
      a.zb ||
    ...
    _.Pd = function (a) {
      ...
      if (!c) {
        if ((b = 0 === b))
          (a = String(a.Cb).match(_.Pb)[1] || null),
            !a &&
              _.v.self &&
              _.v.self.location &&
    ...
    Qd = function (a) {
      if (
        a.la &&
        "undefined" !== typeof _.Ea &&
        (!a.ib[1] || 4 != Od(a) || 2 != a.Za())
      )
        if (a.ab && 4 == Od(a)) Fd(a.mc, 0, a);
    ...
    Sd = function (a) {
      ...
      this.ib = this.v = null;
      this.Cb = "";
      this.sa = this.Ab = this.ab = this.zb = !1;
      this.gb = 0;
      this.fb = null;
      this.oc = "";
      this.Lb = this.Yc = this.Mb = !1;
      this.Jb = null;
    };
    _.B(Sd, _.Kb);
    _.l = Sd.prototype;
    ...
    _.l.send = function (a, b, c, d) {
      if (this.v) throw Error("s`" + this.Cb + "`" + a);
      b = b ? b.toUpperCase() : "GET";
      this.Cb = a;
      this.zb = !1;
      this.la = !0;
      this.v = this.jb ? Ed(this.jb) : Ed(_.Nb);
      this.ib = this.jb ? Dd(this.jb) : Dd(_.Nb);
      this.v.onreadystatechange = (0, _.wd)(this.mc, this);
      this.Yc &&
        "onprogress" in this.v &&
        ((this.v.onprogress = (0, _.wd)(function (g) {
          this.lc(g, !0);
        }, this)),
        this.v.upload && (this.v.upload.onprogress = (0, _.wd)(this.lc, this)));
      try {
        (this.Ab = !0), this.v.open(b, String(a), !0), (this.Ab = !1);
      } catch (g) {
        Nd(this);
        return;
      }
      ...
      "withCredentials" in this.v &&
        this.v.withCredentials !== this.Mb &&
        (this.v.withCredentials = this.Mb);
      if ("setTrustToken" in this.v && this.Jb)
        try {
          this.v.setTrustToken(this.Jb);
        } catch (g) {}
      try {
        Jd(this),
          0 < this.gb &&
            ((this.Lb = Kd(this.v))
              ? ((this.v.timeout = this.gb),
                (this.v.ontimeout = (0, _.wd)(this.qc, this)))
              : (this.fb = Fd(this.qc, this.gb, this))),
          (this.ab = !0),
          this.v.send(a),
          (this.ab = !1);
      } catch (g) {
    ...
    _.l.W = function () {
      this.v &&
        (this.la &&
          ((this.la = !1), (this.sa = !0), this.v.abort(), (this.sa = !1)),
        Md(this, !0));
      Sd.oa.W.call(this);
    };
    _.l.mc = function () {
      this.ta || (this.Ab || this.ab || this.sa ? Qd(this) : this.Xc());
    };
    _.l.Xc = function () {
      Qd(this);
    };
    _.l.lc = function (a, b) {
      this.dispatchEvent(Rd(a, "progress"));
      this.dispatchEvent(Rd(a, b ? "downloadprogress" : "uploadprogress"));
    };
    ...
    _.l.Za = function () {
      try {
        return 2 < Od(this) ? this.v.status : -1;
      } catch (a) {
        return -1;
      }
    };
    ...
    _.l.getAllResponseHeaders = function () {
      return this.v && 2 <= Od(this)
        ? this.v.getAllResponseHeaders() || ""
        : "";
    };
    _.Td = function (a) {
      try {
    ...
    ge.prototype.reset = function () {
      this.j = this.h = 0;
      this.g = _.v.Int32Array ? new Int32Array(this.l) : _.xa(this.l);
    };
    const he = function (a) {
    ...
    ge.prototype.digest = function () {
      let a = [],
        b = 8 * this.j;
      56 > this.h
        ? this.update(_.$a, 56 - this.h)
        : this.update(_.$a, this.blockSize - (this.h - 56));
      for (var c = 63; 56 <= c; c--) (this.i[c] = b & 255), (b /= 256);
      he(this);
      for (c = b = 0; c < this.m; c++)
        for (let d = 24; 0 <= d; d -= 8) a[b++] = (this.g[c] >> d) & 255;
      return a;
    };
    var ie = [
    ...
    qd = function (a) {
      ...
      a = (b = ke) ? b.createHTML(a) : a;
      return new _.db(a, _.cb);
    };
    rd = function (a) {
      a instanceof _.db ||
        ((a = "object" === typeof a && a.fa ? a.Z() : String(a)),
        ce.test(a) &&
    ...
    _.ue = function (a, b) {
      if (a)
        if (_.ob(a)) a.X && _.vb(a.X, b);
        else if ((a = _.Cb(a))) {
          let c = 0;
          b = b && b.toString();
          for (const d in a.g)
            if (!b || d == b)
              for (let e = a.g[d].concat(), f = 0; f < e.length; ++f)
                _.Ib(e[f]) && ++c;
        }
    };
    _.ve = function (a, b, c, d, e, f, g) {
      const h = new Sd();
      Id.push(h);
      b && h.I("complete", b);
      h.Db("ready", h.Jc);
    ...
    _.we = function (a) {
      ...
      const c = new _.Xb(null);
      a = Ud(a);
      for (let d = 0; d < b.length; d++) {
        const e = b[d],
          f = a[d];
        Array.isArray(f) ? _.lc(c, e, f) : c.add(e, f);
      }
      return c;
    };
    _.xe = {};
...
*/
    ...
    let Ce;
    _.$c = function (a, b) {
      if (b !== _.hd) throw Error("C");
      this.R = a;
      if (null != a && 0 === a.length) throw Error("D");
    };
    _.id = function () {
      return Ce || (Ce = new _.$c(null, _.hd));
    };
    var Nc =
      "function" === typeof Symbol && "symbol" === typeof Symbol()
        ...
        : void 0;
    let Ge;
    _.Ee = Object.freeze(_.Sc([]));
    _.Fe = function (a) {
      if (_.H(a.u)) throw Error("G");
    };
    Ge =
      "undefined" !== typeof Symbol && "undefined" !== typeof Symbol.hasInstance;
    let He;
    He = function (a) {
      return a.g || (a.g = a.u[a.i + a.h] = {});
    };
    _.G = function (a, b, c) {
      return -1 === b
        ? null
    ...
    _.I = function (a, b, c, d, e) {
      ...
      (void 0 === e ? 0 : e) || _.Fe(a);
      a.l && (a.l = void 0);
      if (b >= a.i || d) return (He(a)[b] = c), a;
      void 0 !== a.g && a.i >= a.u.length
        ? ((d = a.u.length - 1),
          (e = b + a.h),
          e >= d
            ? ((a.u[d] = void 0), (a.u[e] = c), a.u.push(a.g))
            : (a.u[e] = c))
        : (a.u[b + a.h] = c);
    ...
    _.N = function (a, b, c, d) {
      ...
      const f = a.C[c];
      if (f) b = f;
      else if ((b = _.Yc(_.G(a, c, e), b)))
        (a.C[c] = b), _.Oc(b.u, _.Qc(a.u) & -33);
      if (null == b) return b;
      _.H(b.u) && !_.H(a.u) && ((b = b.Ka()), _.I(a, c, b.u, d), (a.C[c] = b));
      return b;
    };
    _.gd = function (a, b, c) {
      _.Fe(a);
      a.C || (a.C = {});
      const d = null == c ? (c = void 0) : c.u;
      a.C[b] = c;
      return _.I(a, b, d);
    };
    _.fd = function (a, b, c) {
      ...
      if (null != c) {
        ...
        for (var e = !1, f = 0; f < c.length; f++)
          (d[f] = c[f].u), (e = e || _.H(d[f]));
        a.C || (a.C = {});
        a.C[b] = c;
        _.Vc(d, !e);
      } else a.C && (a.C[b] = void 0), (d = _.Ee);
      return _.I(a, b, d);
    };
    const Ke = function (a, b, c) {
      a || (a = _.Je);
      _.Je = null;
      let d = this.constructor.g || 0,
        e = 0 < d,
        f = this.constructor.h;
      a ? _.Qc(a) & 16 && _.Oc(a, 32) : ((a = f ? [f] : []), _.Oc(a, 48));
      e &&
        0 < a.length &&
        Wc(a[a.length - 1]) &&
        "g" in a[a.length - 1] &&
      ...
      a: {
        f = this.u.length;
        d = f - 1;
        if (f && ((f = this.u[d]), Wc(f))) {
          this.g = f;
          b = Object.keys(f);
          0 < b.length && _.Ka(b, isNaN)
            ? (this.i = Number.MAX_VALUE)
            : (this.i = d - this.h);
          break a;
        }
        void 0 !== b && -1 < b
          ? ((this.i = Math.max(b, d + 1 - this.h)), (this.g = void 0))
          : (this.i = Number.MAX_VALUE);
      }
      if (!e && this.g && "g" in this.g) throw Error("I");
      if (c)
        for (e = 0; e < c.length; e++)
          (b = c[e]),
            b < this.i
              ? ((b += this.h),
                (d = this.u[b])
                  ? Array.isArray(d) && _.Sc(d)
                  : (this.u[b] = _.Ee))
              : ((d = He(this)),
                (f = d[b]) ? Array.isArray(f) && _.Sc(f) : (d[b] = _.Ee));
    };
    Ke.prototype.toJSON = function () {
      const a = this.u;
      return _.De ? a : _.bd(a, dd, ed);
    };
    Ke.prototype.ma = function (a) {
      if (a !== _.xe) throw Error("z");
      return _.H(this.u);
    };
    Ke.prototype.toString = function () {
      return this.u.toString();
    };
    _.Le = "function" === typeof Uint8Array.prototype.slice;
    const Me = function () {
    ...
    if (Ge) {
      ...
      Object.defineProperties(
        Me,
        ((Ne[Symbol.hasInstance] = Xc(function () {
          throw Error("T");
        })),
        Ne)
      );
    ...
    _.J(_.O, Me);
    _.O.prototype.Ka = function () {
      if (_.H(this.u)) {
        var a = { xb: !0 };
        const b = _.H(this.u);
        if (b && !a.xb) throw Error("S");
        b || Uc(this.u);
        const c = new this.constructor();
        this.j && (c.j = this.j.slice());
        for (let d = this.u, e = 0; e < d.length; e++) {
          const f = d[e];
          if (e === d.length - 1 && Wc(f))
            for (const g in f) {
              const h = +g;
              Number.isNaN(h) ? (He(c)[g] = f[g]) : jd(this, c, h, f[g], b, a);
            }
          else jd(this, c, e - this.h, f, b, a);
        }
        c.l = this;
        a = c;
      } else a = this;
    ...
    if (Ge) {
      ...
      Object.defineProperties(
        _.O,
        ((Re[Symbol.hasInstance] = Xc(Object[Symbol.hasInstance])), Re)
      );
    }
    _.Te = function (a) {
...
*/
    ...
    let jf, wf, lf, xf, kf, yf, sf, of, pf;
    jf = function (a) {
      if (null != a)
        switch (a.wb) {
          case 1:
    ...
    _.Q = function (a) {
      return _.hf(a, pd)
        ? a
        : a instanceof _.db
        ? (0, _.P)(_.eb(a).toString())
        : a instanceof _.db
        ? (0, _.P)(_.eb(a).toString())
        : (0, _.P)(String(String(a)).replace(kf, lf), jf(a));
    };
    _.P = (function (a) {
      function b(c) {
        this.Ca = c;
    ...
    _.mf = function (a) {
      return a instanceof _.od ? !!a.Ca : !!a;
    };
    _.nf = (function (a) {
      function b(c) {
        this.Ca = c;
    ...
    _.R = function (a) {
      _.hf(a, pd)
        ? ((a = String(a.Ca).replace(of, "").replace(pf, "&lt;")),
          (a = _.qf(a)))
        : (a = String(a).replace(kf, lf));
      return a;
    };
    _.vf = function (a) {
      _.hf(a, _.ef) || _.hf(a, _.ff)
        ? (a = _.rf(a))
        : a instanceof _.D
        ? (a = _.rf(_.oe(a)))
        : a instanceof _.D
        ? (a = _.rf(_.oe(a)))
        : a instanceof _.me
        ? (a = _.rf(_.ne(a).toString()))
        : a instanceof _.me
        ? (a = _.rf(_.ne(a).toString()))
        : ((a = String(a)),
          (a = sf.test(a) ? a.replace(_.tf, _.uf) : "about:invalid#zSoyz"));
      return a;
    };
    wf = {
      "\x00": "&#0;",
    ...
    kf = /[\x00\x22\x26\x27\x3c\x3e]/g;
    yf = /[\x00\x22\x27\x3c\x3e]/g;
    _.tf =
      /[\x00- \x22\x27-\x29\x3c\x3e\\\x7b\x7d\x7f\x85\xa0\u2028\u2029\uff01\uff03\uff04\uff06-\uff0c\uff0f\uff1a\uff1b\uff1d\uff1f\uff20\uff3b\uff3d]/g;
    sf =
      /^[^&:\/?#]*(?:[\/?#]|$)|^https?:|^ftp:|^data:image\/[a-z0-9+]+;base64,[a-z0-9+\/]+=*$|^blob:/i;
    _.qf = function (a) {
      return String(a).replace(yf, lf);
    };
    _.rf = function (a) {
      return String(a).replace(_.tf, _.uf);
    };
    of = /<(?:!|\/?([a-zA-Z][a-zA-Z0-9:\-]*))(?:[^>'"]|"[^"]*"|'[^']*')*>/g;
    pf = /</g;
    /*
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
  ...
  try {
    ...
    _.ci = function (a, b, c) {
      ...
      if (b && 2 === b.Sb()) {
        ...
        b && 2 === _.G(b, 10) && !_.$e("disable_personalized_button")
          ? ((c = void 0 === c ? !0 : c),
            b && _.Ie(b, 8)
              ? ((d = {}),
                b &&
    ...
    const ji = function (a) {
      ...
      ki = {},
      li = function (a, b) {
        return a && b && a.Uc && b.Uc
          ? a.Aa !== b.Aa
            ? !1
            : a.toString() === b.toString()
          : a instanceof _.od && b instanceof _.od
          ? a.Aa != b.Aa
            ? !1
            : a.toString() == b.toString()
          : a == b;
      ...
      oi = function (a) {
        _.hf(a, ki)
          ...
          : a instanceof ii
          ? (a = mi(ji(a)))
          : ((a = String(a)), (a = ni.test(a) ? a : "zSoyz"));
        return a;
      },
      pi = function () {
        return (0, _.P)(
    ...
    var vi = function (a, b, c, d, e, f, g, h) {
        g = void 0 === g ? !0 : g;
        h = void 0 === h ? !1 : h;
        const k = e && 1 != e ? _.Q(ri(e)) : _.Q(ri(2));
        const m = _.P;
        g =
          "<div" +
          (g ? ' tabindex="0"' : "") +
    ...
    _.Oi = function () {
      return (
        ...
        ((_.w("iPad") || _.w("iPhone")) &&
          ...
          !_.nc() &&
          _.w("AppleWebKit")) ||
        (_.ua() && 0 <= _.yd(_.Fc(), "14.4")) ||
        (_.nc() && 0 <= _.yd(_.Ki(), "100") && _.$e("enable_itp_on_firefox"))
      );
    };
    _.Li = function () {
      return (
...
*/
  ...
  try {
    _.Tk = function (a) {
      const b = {};
      if (a)
        for (let c = _.u(Object.keys(a)), d = c.next(); !d.done; d = c.next())
          (d = d.value), void 0 !== a[d] && "" !== a[d] && (b[d] = a[d]);
      return b;
    };
    _.Uk = function (a, b) {
      a = new _.Rb(a);
      b && _.Ub(a, _.we(_.Tk(b)));
      return a.toString();
    };
    _.Wk = function (a, b) {
    ...
    _.Xk = function (a) {
      var b = void 0 === b ? _.df : b;
      a: {
        b = void 0 === b ? _.df : b;
        for (let c = 0; c < b.length; ++c) {
          const d = b[c];
          if (d instanceof _.ld && d.Vc(a)) {
            a = new _.D(a, _.ab);
            break a;
          }
        }
    ...
    _.Vk = function (a) {
      ...
      a = "object" === typeof a && a.fa ? a.Z() : String(a);
      _.Sk.test(a) || (a = "about:invalid#zClosurez");
      return new _.D(a, _.ab);
    };
  } catch (e) {
    _._DumpException(e);
  }
  try {
    let ul, sl;
    _.tl = function (a, b) {
      let c = Math.min(500, screen.width - 40);
      let d = Math.min(550, screen.height - 40);
      c = [
      ...
      d = a;
      d instanceof _.D ||
        ((d = "object" === typeof d && d.fa ? d.Z() : String(d)),
        _.Sk.test(d)
          ? (d = new _.D(d, _.ab))
          : ((d = String(d).replace(/(%0A|%0D)/g, "")),
            (d = d.match(sl) ? new _.D(d, _.ab) : null)));
      b = b.Z();
      b = window.open(_.Rk(d || _.bb), b, c);
...
*/
    ...
    Bm = !_.Na && !_.pc();
    _.Cm = function (a) {
      if (Bm && a.dataset) return a.dataset;
      const b = {};
      a = a.attributes;
      for (let c = 0; c < a.length; ++c) {
        const d = a[c];
        if (0 == d.name.lastIndexOf("data-", 0)) {
          const e = _.zm(d.name.slice(5));
          b[e] = d.value;
        }
      }
      return b;
    ...
    _.Em = (function () {
      if (_.sc) return Dm(/Firefox\/([0-9.]+)/);
      if (_.Na || _.Oa || _.Ma) return _.Xa;
      if (_.wc) {
        if (_.ua() || _.w("Macintosh")) {
          var a = Dm(/CriOS\/([0-9.]+)/);
          if (a) return a;
        }
        return Dm(/Chrome\/([0-9.]+)/);
      }
      if (_.xc && !_.ua()) return Dm(/Version\/([0-9.]+)/);
      if (_.tc || _.uc) {
        if ((a = /Version\/(\S+).*Mobile\/(\S+)/.exec(_.qa())))
          return a[1] + "." + a[2];
      } else if (_.vc)
        return (a = Dm(/Android\s+([0-9.]+)/)) ? a : Dm(/Version\/([0-9.]+)/);
      return "";
    })();
  } catch (e) {
    _._DumpException(e);
  ...
  try {
    ...
    _.Gm = function () {
      ...
      (window.crypto || _.mc.msCrypto).getRandomValues(a);
      return a[0].toString(16) + a[1].toString(16);
    };
    _.Im = function (a) {
      _.Fm(window.parent, a, _.Hm);
    };
    _.Pm = function (a, b, c) {
      Jm
        ? _.y(
    ...
    Km = function (a) {
      ...
      if ("string" === typeof a) return Qm(a);
      if (Array.isArray(a)) {
        for (let b = 0; b < a.length; b++)
          if ("string" !== typeof a[b] || !Qm(a[b])) return !1;
        return !0;
      }
      return !1;
    };
    Qm = function (a) {
      try {
        ...
        a = c;
        b = "Bb";
        if (Rm.Bb && Rm.hasOwnProperty(b)) var d = Rm.Bb;
        else {
          const e = new Rm();
          d = Rm.Bb = e;
        }
    ...
    Mm = function () {
      Tm ||
        (Tm = _.E(window, "message", function (a) {
          a = a.T;
          if (a.data) {
            const b = a.data;
    ...
    _.Xm = function (a) {
      _.Hm
        ? _.Im({ command: "intermediate_iframe_resize", height: a })
        : _.y(
    ...
    _.Ym = function () {
      _.Hm
        ? _.Im({ command: "intermediate_iframe_close" })
        : _.y(
    ...
    _.Zm = function (a) {
      _.Hm
        ? _.Im({ command: "set_tap_outside_mode", cancel: a })
        : _.y(
...
*/
    ...
    var cn = function (a, b, c) {
      void 0 !== a.R && c.push(b);
      for (const d in a.g) cn(a.g[d], b + d, c);
    };
    var Rm = function () {
        this.g = dn(
      ...
      en = function (a, b, c, d) {
        ...
        a++;
        if ("?" == e || "," == e) return a;
        do (a = en(a, b, c, d)), (e = c.charAt(a));
        while ("?" != e && "," != e);
        return a + 1;
      };
    let Lm, Tm, Jm, Nm, Om;
    _.A("google.accounts.id.intermediate.verifyParentOrigin", _.Pm);
    _.A("google.accounts.id.intermediate.notifyParentResize", _.Xm);
    _.A("google.accounts.id.intermediate.notifyParentClose", _.Ym);
    _.A("google.accounts.id.intermediate.notifyParentDone", function () {
      _.Hm
        ? _.Im({ command: "intermediate_iframe_done" })
        : _.y(
            "Done command was not sent due to missing verified parent origin."
          );
    });
    _.A("google.accounts.id.intermediate.notifyParentTapOutsideMode", _.Zm);
  } catch (e) {
    _._DumpException(e);
  }
  try {
    var Z = function (a, b) {
      ...
      jn = function () {
        ...
        for (b = a.next(); !b.done; b = a.next())
          if (
            ...
            return _.fc(b).j.get("client_id") || null;
        return null;
      },
      kn = function (a) {
        if (!a) return null;
      ...
      mn = function () {
        let a = _.Gm().toString(),
          b = { ic: 300, path: "/", Hb: !0 },
          c;
        if ((c = _.oc())) c = 0 <= _.yd(_.Em, 80);
        c && (b.Gb = "none");
        c = _.fc(location.origin);
        "http" === c.h &&
          "localhost" === c.g &&
      ...
      pn = function (a) {
        ...
        if (!(document.getElementById(b) && nn.get(b) && nn.get(b))) {
          const c = new _.af(),
      ...
      qn = function (a) {
        let b = document.getElementById("credential_picker_iframe");
        return b
      ...
      tn = function (a, b, c, d) {
        d = void 0 === d ? !1 : d;
        const e = _.rc(document, "iframe");
        e.setAttribute("src", b);
        e.id = c;
        e.title = "[Google\u3067\u30ed\u30b0\u30a4\u30f3]\u30dc\u30bf\u30f3";
      ...
      wn = function (a) {
        let b = _.F("g_a11y_announcement");
        b ||
          ((b = _.rc(document, "div")),
          (b.id = "g_a11y_announcement"),
          document.body.appendChild(b));
        const c = _.rc(document, "span");
        vn(c, a);
        c.role = "alert";
        _.se(b);
        b.appendChild(c);
      ...
      Bn = function (a, b) {
        xn >= (void 0 === b ? 100 : b) ||
          ((b = new _.Rb(yn)),
          _.Ub(b, _.we({ client_id: zn, as: An, event: a.toString() })),
          _.ve(
            b.toString(),
            void 0,
            "POST",
            ...
            void 0,
            void 0,
            "https://accounts.google.com/gsi/log" !== yn
          ));
      },
      Fn = function (a) {
        const b = new (Function.prototype.bind.apply(
          Cn,
          [null, "onetap", a, "prompt"].concat(Dn(En.apply(1, arguments)))
        ))();
        Bn(b);
      },
      Gn = function () {
        const a = new (Function.prototype.bind.apply(
          Cn,
          [null, "onetap", void 0, "closed"].concat(Dn(En.apply(0, arguments)))
        ))();
        Bn(a);
      },
      Hn = function () {
        const a = new (Function.prototype.bind.apply(
          Cn,
          [null, "id", void 0, "init"].concat(Dn(En.apply(0, arguments)))
        ))();
        Bn(a);
      },
      Nn = function () {
        let a = _.F("g_id_onload");
        if (a) {
          let b = _.Cm(a);
          a = _.ym(b, In);
          ...
          for (d in b)
            b.hasOwnProperty(d) &&
              0 > Jn.indexOf(d.toLowerCase()) &&
              (c[d] = b[d]);
          a.state && (c.state = a.state);
          if ((d = a.login_uri)) {
            b = _.fc(d);
            b.g ||
              (_.Sb(b, location.protocol),
              (b.g = location.hostname),
              _.Tb(b, location.port),
              Hn("relativeLoginUri", d),
              _.y(
            ...
            if ("https" !== b.h && "localhost" !== b.g)
              throw (
                (Hn("unsecuredLoginUri", d),
                new Kn("Unsecured login_uri provided."))
              );
            d = b.toString();
            a.login_uri = d;
          }
          d && !a.callback && (a.callback = Ln(d, c));
          "redirect" !== a.ux_mode ||
            d ||
      ...
      Mn = function (a, b, c, d) {
        return function (e) {
          e && "password" === e.type
            ? ((b[c] = e.id), (b[d] = e.password), _.Wk(a, b))
      ...
      Tn = function (a) {
        a = new Qn(a);
        Rn.__G_ID_CLIENT__ = a;
        pn(a.Fc);
        Sn(a);
        return a;
      },
      Un = function (a, b, c) {
        let d = Rn.__G_ID_CLIENT__;
        d || (Tn(), (d = Rn.__G_ID_CLIENT__));
        d.N(a, b, c);
      },
      Wn = function (a, b, c) {
        if (a && b) {
          const d = Rn.__G_ID_CLIENT__;
          d
            ? Vn(d, a, b, c)
      ...
      Yn = function () {
        let a = Rn.__G_ID_CLIENT__;
        a || (Tn(), (a = Rn.__G_ID_CLIENT__));
        Xn(a.o);
      },
      Zn = function () {
        var a = void 0 === a ? document.readyState : a;
        for (let b = _.qe("g_id_signout"), c = 0; c < b.length; c++)
          _.E(b[c], "click", Yn);
        try {
          const d = Nn();
          if (d) {
            const e = d.auto_prompt;
            delete d.auto_prompt;
            const f = d.moment_callback;
      ...
      $n = function () {
        const a = Rn.onGoogleLibraryLoad;
      ...
      eo = function (a, b, c) {
        ...
        co(c, "access_type", g);
        co(c, "hd", n);
        co(c, "response_type", f);
        co(c, "include_granted_scopes", !1 === p ? "false" : "true");
        co(c, "enable_serial_consent", !1 === t ? "false" : "true");
        return b + "?" + c.join("&");
      },
      go = function (a, b) {
        if (!b.client_id) throw new fo("Missing required parameter client_id.");
        if (!b.scope) throw new fo("Missing required parameter scope.");
        const c = {
      ...
      ho = function () {
        let a = En.apply(0, arguments),
          b = [];
        if (a) {
          a = _.u(a);
          for (let c = a.next(); !c.done; c = a.next()) {
            const d = (c = c.value) && c.trim();
            !d && 0 <= d.indexOf(" ")
              ? (_.y(
      ...
      io = function (a) {
        return (a = a && a.scope && a.scope.trim())
          ? ho.apply(null, Dn(a.split(" ")))
          : null;
      },
      jo = function (a) {
        _.wl(a, "prompt_closed", { md: !1 });
      },
      ko = function (a, b, c) {
        b = { rd: b };
        void 0 !== c && (b.sd = c);
        _.wl(a, "prompt_resized", b);
      },
      Dn = function (a) {
    ...
    var on = function (a, b) {
      ...
      lo = ["debug", "info", "warn"],
      fo = function () {
        const a = Error.apply(this, arguments);
    ...
    _.J(no, _.O);
    const oo = { left: 1, center: 2 },
      po = { rectangular: 1, square: 3, pill: 2, circle: 4 },
      qo = { large: 1, medium: 2, small: 3 },
      ro = { signin: 1, signin_with: 2, signup_with: 3, continue_with: 4 },
      so = { outline: 1, filled_blue: 2, filled_black: 3 },
      to = { standard: 1, icon: 2 },
      uo = function (a, b, c) {
        this.container = a;
        this.h = c;
        this.g = !1;
        a = new _.qi();
        b &&
          (b.logo_alignment && _.I(a, 6, oo[b.logo_alignment]),
          b.shape && _.I(a, 3, po[b.shape]),
          b.size && _.I(a, 1, qo[b.size]),
          b.text && _.I(a, 5, ro[b.text]),
          b.theme && _.I(a, 2, so[b.theme]),
          b.type && _.I(a, 7, to[b.type]),
      ...
      vo = function (a) {
        if (!a.g) {
          _.ci(a.container, a.buttonAttributes);
          const b = _.re("nsm7Bb-HzV7m-LgbsSe", a.container);
          b &&
            a.h &&
            ln(b, function () {
              a.h && a.h.call(a);
    ...
    uo.prototype.S = function () {
      if (!this.g) {
        const a = _.re("nsm7Bb-HzV7m-LgbsSe", this.container);
        a && _.te(a);
        this.g = !0;
    ...
    var rn = function () {
      return "[Google\u3067\u30ed\u30b0\u30a4\u30f3]\u30c0\u30a4\u30a2\u30ed\u30b0";
    };
    var nn = new Map();
    var Cn = function (a, b, c) {
      const d = En.apply(3, arguments);
      this.j = a;
      this.i = b;
      this.g = c;
      this.h = d;
    ...
    Cn.prototype.toString = function () {
      ...
      this.h && a.push.apply(a, Dn(this.h));
      return a.join(".");
    };
    var xn = Math.floor(100 * Math.random()),
      yn = "https://accounts.google.com/gsi/log",
      zn,
      An;
    var xo = [0, 7200, 86400, 604800, 2419200],
      yo = function (a, b, c) {
        this.i = a;
...
*/
    ...
    var Go = { done: !0, value: void 0 };
    Fo.prototype.za = function () {
      return this;
    };
    var Ko = function (a) {
        if (a instanceof Ho || a instanceof Io || a instanceof Jo) return a;
        if ("function" === typeof a.next)
          return new Ho(function () {
            return a;
          });
    ...
    Ho.prototype.za = function () {
      return new Io(this.g());
    };
    Ho.prototype[Symbol.iterator] = function () {
      return new Jo(this.g());
    };
    ...
    Io.prototype[Symbol.iterator] = function () {
      return new Jo(this.g);
    };
    ...
    const Mo = function () {};
    _.B(Mo, Lo);
    Mo.prototype[Symbol.iterator] = function () {
      return Ko(this.za(!0)).h();
    };
    const No = function (a) {
      this.g = a;
    };
    ...
    Po.prototype.rb = function (a) {
      this.h.rb(this.g + a);
    };
    Po.prototype.za = function (a) {
      const b = this.h[Symbol.iterator](),
        c = this,
        d = new Fo();
      d.next = function () {
        let e = b.next();
    ...
    const Qo = new _.vl("g_credential_picker"),
      Ro = ["bottom_sheet", "card"],
      So = ["signin", "signup", "use"],
      Uo = function (a, b) {
        b = void 0 === b ? "i_" : b;
        const c = new Oo();
        if (c.g)
        ...
        this.F = d ? new Po(c, "g_state_id_") : null;
        this.Hc = b;
        ...
        this.O = null;
        b = new Uint8Array(16);
        (window.crypto || _.mc.msCrypto).getRandomValues(b);
        this.A = btoa(String.fromCharCode.apply(String, Dn(b))).replace(
          /=+$/,
          ""
        );
        this.D = {};
    ...
    _.J(Uo, _.Ve);
    var To = function (a, b) {
      let c = a.F ? a.F.get("ll") || void 0 : void 0;
      if (c) Vo(a, c);
      else {
        if ((c = void 0 !== b.log_level))
          (c = b.log_level), (c = void 0 === c || 0 <= (0, _.va)(lo, c));
        c && Vo(a, b.log_level);
      }
      a.Ec = b.button_url || "https://accounts.google.com/gsi/button";
      a.Ra = b.picker_url || "https://accounts.google.com/gsi/select";
      a.Pc = b.prompt_url || "https://accounts.google.com/gsi/iframe/select";
      a.bc = b.status_url || "https://accounts.google.com/gsi/status";
      a.K = _.Am(a.bc);
      a.Fc = b.container_css_url || "https://accounts.google.com/gsi/style";
      a.Qc = b.revoke_url || "https://accounts.google.com/gsi/revoke";
      c = a.K;
      const d = b.client_id,
        e = a.A;
      yn = c ? c + "/gsi/log" : "https://accounts.google.com/gsi/log";
      zn = d;
      An = e;
      a.callback = b.callback;
      a.Ba = "redirect" === b.ux_mode ? "redirect" : "popup";
      c = b.ui_mode;
      (void 0 != c && 0 <= (0, _.va)(Ro, c)) ||
      ...
      a.container =
        (b.prompt_parent_id
          ...
          : null) || document.body;
      a.Lc = 9e4;
      a.ia = !1 !== b.cancel_on_tap_outside;
      a.ua = !0 === b.itp_support;
      a.ca =
        void 0 === b.use_fedcm_for_prompt ? void 0 : !!b.use_fedcm_for_prompt;
      c = b.state_cookie_domain;
      !c || (null != c && Eo.test(c)) || (c = void 0);
      a.o = new yo(c, a.Hc, b.state_cookie_name);
      a.ya(b);
      c = {};
      ...
      "warn" !== _.za && (c.log_level = _.za);
      void 0 != b.hl && (c.hl = b.hl);
      void 0 !== b.disable_auto_focus &&
        (c.disable_auto_focus = b.disable_auto_focus);
      c.as = a.A;
      _.$e("rp_cancelable_auto_select") && (c.feature = "cancelableAutoSelect");
      a.xa(c);
      a.g = c;
    };
    Uo.prototype.ya = function () {};
    Uo.prototype.xa = function () {};
    var Sn = function (a) {
        a.va ||
          ((a.va = !0),
          _.E(
          ...
          (a.O = _.E(document, "click", function () {
            a.ia && Xo(a, !1) && (Yo(a, "tap_outside"), Gn("tapOutside"));
          })));
      },
      Zo = function (a) {
    ...
    Uo.prototype.N = function (a, b, c) {
      const d = this;
      Xo(this, !0) && ($o(this, "flow_restarted"), Gn("flowRestarted"));
      this.l = a;
      this.ja = c;
        ...
        ? _.$e("unsupported_browser")
          ...
          ? (Z(
            ...
            Fn(
              a,
              "cooldown",
              (Ao(this.o).prompt_suppress_level || 0).toString()
            ))
          : ("IdentityCredential" in window ||
            ...
            (this.ca ||
              (void 0 === this.ca &&
                _.Qi.enable_fedcm.includes(this.g.client_id) &&
                _.$e("enable_fedcm_via_userid")))
          ? Zo(this)
          : ap(this, function (e) {
              e && _.L(e, 3)
    ...
    var Vn = function (a, b, c, d) {
        ...
        d.add("iframe_id", e);
        d.add("as", a.A);
        g.locale && (d.add("hl", g.locale), _.jc(d, "locale"));
        "warn" !== _.za && d.add("log_level", _.za);
        a.i.hint && d.add("hint", a.i.hint);
        a.i.hosted_domain && d.add("hosted_domain", a.i.hosted_domain);
        _.Ub(f, d);
        g = _.Ni();
        f = tn(h, f.toString(), e, g);
        g &&
          ln(f, function (k) {
            k.preventDefault();
            k.stopPropagation();
      ...
      ep = function (a, b, c, d) {
        const e = _.rc(document, "div");
        b.appendChild(e);
        b = new uo(e, c, function () {
          fp(a, d);
        });
        vo(b);
        return b;
          ...
          d
            ? d.handler
              ...
              : ((b = {}),
                ...
                Xo(a, !0) && ($o(a, "flow_restarted"), Gn("buttonFlowStarted")),
                ...
                "redirect" === a.Ba
                  ? (a.g.login_uri ||
                      (a.g.login_uri =
                        ...
                        location.pathname),
                    (a.g.g_csrf_token = mn()),
                    (a = _.Xk(_.Uk(a.Ra, a.g))),
                    top.location.replace(_.Rk(a)))
                  : ((a.m = _.Gm()),
                    (a.g.channel_id = _.Kc(a.m)),
                    (a.g.origin = a.g.origin || location.origin),
                    _.tl(_.Uk(a.Ra, a.g), Qo) ||
                      Bn(
                        new Cn("button", "popup", "clicked", "popupNotOpened")
                      )))
            : _.z("A button entry was not found for the given id.");
        }
      },
      Xo = function (a, b) {
        if (a.ra) return a.s ? (a.s.abort(), (a.s = null), !0) : !1;
        const c = a.container;
        if (
          !(
        ...
        if (!qn(a.container)) return Z("Failed to remove prompt iframe."), !1;
        jo(a);
        a.B = !0;
        a.O && (_.Ib(a.O), (a.O = null));
        return !0;
      };
    ...
    var dp = function (a, b, c) {
      ...
      $o = function (a, b) {
        if (a.l) {
          const c = a.l;
          a.l = void 0;
          const d = new wo("dismissed");
          d.i = b;
          c.call(a, d);
        }
      },
      hp = function (a, b) {
        a.ja && a.ja.call(a, { type: b, message: void 0 });
      },
      ap = function (a, b) {
        let c = { client_id: a.g.client_id };
      ...
      bp = function (a) {
        ...
        a.B = !0;
        a.ac(b);
        _.wl(a, "prompt_displayed");
      };
    Uo.prototype.ac = function (a) {
      sn(this.container, a, "bottom_sheet" === this.uiMode);
    };
    var cp = function (a) {
        "bottom_sheet" === a.uiMode &&
          window.setTimeout(function () {
            Xo(a, !1) && (Yo(a, "auto_cancel"), Gn("autoCancel"));
          }, a.Lc);
      },
      Wo = function (a, b) {
      ...
      if (a.data && a.data.type)
        switch (
          ...
          case "response":
            ...
            b &&
              (d
                ? $o(this, "credential_returned")
                : (Yo(this, "issuing_failed"), Gn("issuingFailed")),
              jo(this));
            a.data.announcement && wn(a.data.announcement);
            break;
          case "activity":
            a.data.activity && this.cb(a.data.activity);
            break;
          case "command":
            if ((b = a.data.command))
              switch (b) {
                case "close":
                  a.data.suppress &&
                    ...
                    (b.disable_auto_prompt =
                      new Date().getTime() + 1e3 * xo[b.prompt_suppress_level]),
                    Bn(
                      new Cn(
                        "onetap",
                        void 0,
                    ...
                    Bo(a, b));
                  Xo(this, !0) &&
                    (Yo(this, "user_cancel"), jo(this), Gn("userCancel"));
                  break;
                case "resize":
                  a = a.data.height;
                  if (un(a)) {
                ...
                case "start_auto_select":
                  hp(this, "auto_select_started");
                  break;
                case "cancel_auto_select":
                  Xn(this.o), hp(this, "auto_select_canceled");
              }
        }
    };
    var ip = function (a, b, c) {
        const d = { successful: !1 },
          e = a.g.client_id;
        e
          ? ((b = { client_id: e, hint: b }),
            a.A && (b.as = a.A),
            gn(a.Qc, b, function (f) {
              if (f && "null" !== f) {
                if (
                  ((f = new no(_.kd(f))),
      ...
      Vo = function (a, b, c) {
        (void 0 === c ? 0 : c) && a.F && (b ? a.F.set("ll", b) : a.F.rb("ll"));
        _.Gc(b);
      };
    var In = {
        client_id: "str",
    ...
    var Qn = function (a) {
      ...
      this.wa = !1;
      this.J = !!this.h;
      this.ka = a && a.intermediate_iframe_close_callback;
      if (this.h && this.h)
        if ("string" === typeof this.h) {
          if (!hn(this.h)) throw Error("ya");
        } else if (Array.isArray(this.h))
          for (a = 0; a < this.h.length; a++)
            if ("string" !== typeof this.h[a] || !hn(this.h[a]))
              throw Error("za");
    };
    _.J(Qn, Uo);
    ...
    var jp = function (a) {
      a.wa ||
        ...
        "credentials" in navigator &&
          navigator.credentials
            .get({ password: !0, od: "required" })
            .then(function (b) {
              a.G && a.G(b);
            }));
    };
    Qn.prototype.N = function (a, b, c) {
      const d = this;
      this.J && this.h
        ? (_.x("Verifying parent origin."),
          _.Pm(this.h, function () {
            _.Hm
              ? _.Im({ command: "set_ui_mode", mode: d.uiMode })
              : _.y(
                  "Set ui mode command was not sent due to missing verified parent origin."
                );
            _.Zm(!1);
            d.Zb = !1;
            Uo.prototype.N.call(d, a, b, c);
          }))
        : Uo.prototype.N.call(this, a, b, c);
    };
    Qn.prototype.V = function (a) {
      Uo.prototype.V.call(this, a);
      if (this.J && a.data && a.data.type)
        switch (a.data.type) {
          case "response":
            a.data.response &&
          ...
          case "command":
            switch (a.data.command) {
              case "close":
                this.Zb ? _.Xm(0) : this.ka ? (_.Xm(0), this.ka()) : _.Ym();
                break;
              case "resize":
                a = a.data.height;
                "number" === typeof a && !isNaN(a) && 0 < a && _.Xm(a);
                break;
              case "cancel_protect_start":
                _.Zm(!1);
                break;
    ...
    Qn.prototype.ac = function (a) {
      sn(this.container, a, "bottom_sheet" === this.uiMode, this.J);
    };
    Qn.prototype.xa = function (a) {
      if (this.J)
        switch (_.Vm) {
    ...
    _.A("google.accounts.id.cancel", function () {
      const a = Rn.__G_ID_CLIENT__;
      a && Xo(a, !0) && ($o(a, "cancel_called"), Gn("cancel"));
    });
    _.A("google.accounts.id.disableAutoSelect", Yn);
    _.A("google.accounts.id.initialize", Tn);
    _.A("google.accounts.id.prompt", Un);
    _.A("google.accounts.id.PromptMomentNotification", wo);
    _.A("google.accounts.id.renderButton", Wn);
    _.A("google.accounts.id.revoke", function (a, b) {
      const c = Rn.__G_ID_CLIENT__;
      c ? ip(c, a, b) : _.z("Attempt to call revoke() before initialize().");
    });
    ...
    _.A("google.accounts.id.setLogLevel", function (a) {
      let b = Rn.__G_ID_CLIENT__;
      b || (Tn(), (b = Rn.__G_ID_CLIENT__));
      a = a ? a.toLowerCase() : void 0;
      void 0 === a || 0 <= (0, _.va)(lo, a)
        ? Vo(b, a, !0)
        : (_.z(
    ...
    const np = new _.vl("g_auth_code_window"),
      op = function (a) {
        kp.call(this, "code", a);
    ...
    op.prototype.requestCode = function () {
      let a = this.j;
      "redirect" === this.Ba
        ? (Z("Starting redirect flow.", "CODE_CLIENT"),
          (a = _.Xk(eo(this.h, this.i, a))),
          window.location.assign(_.Rk(a)))
        : (Z("Starting popup flow.", "CODE_CLIENT"),
          lp(this),
          mp(this, a),
          _.tl(eo(this.h, this.i, a), np));
    };
    const pp = new _.vl("g_auth_token_window"),
      qp = window,
      rp = function (a) {
        kp.call(this, "token", a);
        this.callback = a.callback;
    ...
    rp.prototype.l = function (a) {
      ...
      if (a.access_token)
        if (qp.gapi && qp.gapi.client && qp.gapi.client.setToken)
          try {
            qp.gapi.client.setToken.call(this, a);
          } catch (b) {
    ...
    rp.prototype.requestAccessToken = function (a) {
      let b = this.j;
      a = a || {};
      b = go(this.h, {
        client_id: b.client_id,
      ...
      lp(this);
      mp(this, b);
      _.tl(eo(this.h, this.i, b), pp);
    };
    _.A("google.accounts.oauth2.initCodeClient", function (a) {
      return new op(a);
    });
    _.A("google.accounts.oauth2.CodeClient", op);
    _.A("google.accounts.oauth2.initTokenClient", function (a) {
      return new rp(a);
    });
    _.A("google.accounts.oauth2.TokenClient", rp);
    _.A("google.accounts.oauth2.hasGrantedAllScopes", function (a) {
      let b = En.apply(1, arguments),
        c = io(a);
      return c && c.length
        ? (b = ho.apply(null, Dn(b))) && b.length
          ? (0, _.Ka)(b, function (d) {
              return 0 <= (0, _.va)(c, d);
            })
          : !1
